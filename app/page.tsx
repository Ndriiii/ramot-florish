...
return (
    <main className = "min-h-screen bg-[#EFE8E8] text-text-[#171717] font-sans selection:bg-green-200">
        <nav className = "fixed top-0 left-0 right-0 z-50 bg-[#EFE8E8]/80 backdrop-blur-md border-b border-gray-300/50">
            <div className = "max-w-7xl mx-auto px-6 md:px-20 h-20 flex items-center justify-between">
                ...
                <div className = "hidden md:flex items-center gap-8 text-sm font-bold uppercase tracking-widest text-gray-500">
                    ...
                    <button onClick={() => document.getElementById('catalog')?.scrollIntoView({ behavior: 'smooth' })} className="hover:text-[#171717] hover:cursor-pointer transition-colors">Catalogue</button>
                    <button onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })} className="hover:text-[#171717] hover:cursor-pointer transition-colors">Contact</button>
                    <button onClick={() => document.getElementById('location')?.scrollIntoView({ behavior: 'smooth' })} className="hover:text-[#171717] hover:cursor-pointer transition-colors">Location</button>
                </div>
                <a
        ...
        <footer id = "location" className="relative text-[#171717] py-16 px-6 overflow-hidden bg-[#EFE8E8]">
            <div className = "absolute inset-0 bg-[#626262] opacity-10 pointer-events-none"></div>
    ...
    <div className = "fixed inset-0 z-50 flex items-center justify-center p-4 md:p-8">
        ...
        <div className = "relative bg-[#EFE8E8] w-full max-w-4xl rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row animate-in fade-in zoom-in duration-200 max-h-[95vh] overflow-y-auto">            
            <button onClick = {() => setSelectedProduct(null)} className="absolute top-4 right-4 p-2 bg-white/50 hover:bg-white rounded-full z-20 transition shadow-sm"> ✕ </button>
            <div className = "w-full md:w-1/2 relative bg-white flex items-center justify-center p-6">
                <Image 
            ...
            <div className = "w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center space-y-6">
                ...
                <p className = "text-gray-600 leading-relaxed text-lg">{SelectedProduct.desc}</p>
