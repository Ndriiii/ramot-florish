...
const PRODUCTS: Product[] = [
    { id: 1, name: "Bunga Salib", images: ["/Salib.webp", "/Salib1.webp", "/Salib2.webp", "/Salib3.webp", "/Salib4.webp", "/Salib5.webp", "/Salib6.webp"]},
    { id: 2, name: "Papan Bunga Jumbo", images: ["/Jumbo.webp"]},
    { id: 3, name: "Papan Jakarta", images: ["/PapanJakarta.webp"]},
    { id: 4, name: "Papan Jakarta Mahkota Bunga Fresh", images: ["/JakartaFresh.webp"]},
    { id: 5, name: "Papan Jakarta Jumbo Mahkota 4", images: ["/JakartaJumbo.webp"]},
    { id: 6, name: "Papan Bunga Mahkota 1", images: ["/Mahkota1.webp"]},
    { id: 7, name: "Papan Bunga 3 Mahkota", images: ["/Mahkota3.webp"]},
    { id: 8, name: "Papan Bunga 4 Mahkota", images: ["/Mahkota4.webp"]},
    { id: 9, name: "Papan Bunga Mahkota 4", images: ["/Mahkota4B.webp"]},
    { id: 10, name: "Papan Bunga Mahkota 5", images: ["/Mahkota5.webp"]},
    { id: 11, name: "Papan Printing", images: ["/Printing.webp"]}
];
...
export default function Home() {
    ...
    // Fungsi Pelacakan Klik WhatsApp untuk Google Ads
        ...
        <nav className = "fixed top-0 left-0 right-0 z-50 bg-[#EFE8E8]/80 backdrop-blur-md border-b border-gray-300/50">
            <div className = "max-w-7xl mx-auto px-6 md:px-20 h-20 flex items-center justify-between">
                ...
                <a
                    ...
                    onClick = {handleConversionTrack} // Track Google Ads
            ...
            >
                ...
                <div className = "relative bg-[#EFE8E8] w-full max-w-4xl rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row max-h-[92vh] overflow-y-auto">            
                    ...
                    <div className = "w-full md:w-1/2 p-6 md:p-12 flex flex-col justify-center space-y-5 md:space-y-6">
                        ...
                        <a href = {getWhatsAppUrl()} target = "_blank" rel="noopener noreferrer" onClick = {handleConversionTrack} className = "inline-flex items-center justify-center gap-2 px-8 py-4 bg-green-700 text-white rounded-full font-bold hover:bg-green-600 transition shadow-lg active:scale-95 w-full">
                            <WhatsAppIcon/>
                            Order via WhatsApp
                        </a>
                    </div>
